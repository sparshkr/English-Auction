...
export default function Home() {
  ...
  return (
    <div className="grid justify-center grid-cols-1 md:grid-cols-[1fr_512px_1fr] bg-gradient-to-b from-[#4A038B] to-[#0C0D29] overflow-hidden min-h-screen">
      <div className="relative col-start-1 md:col-start-2 col-span-1 mb-2 overflow-hidden px-4 md:px-0">
        ...
        <div className="relative z-50 my-0 mb-6 md:mb-10">
          <Topbar />
        </div>

        <div className="relative z-90 text-white text-xl md:text-2xl lg:px-8 mb-4 flex justify-between items-center px-2">
          <span>{ProductName}</span>
          <span className="font-bold text-2xl mx-2 absolute left-[50%]">|</span>
          <span>${ProductPrice}</span>
        </div>

        <div className="relative z-10 w-full text-white flex justify-center items-center flex-wrap gap-4 md:gap-5 flex-col pt-4 mb-2">
          <div className="flex flex-col sm:flex-row justify-center items-start transition-all duration-300 w-full relative gap-6">
            <div
            ...
            <div
              className={`absolute sm:relative right-0 top-0 sm:top-auto mt-4 sm:mt-0 max-h-[300px] overflow-hidden transition-all duration-500 bg-[#0C0D29]/10 backdrop-blur-sm p-2 rounded-lg z-10 opacity-100 w-[120px] sm:w-[100px] flex flex-col items-center`}
            >
              {bids.map((bid, index) => (
                <div
                  key={index}
          ...
          <div
            className={`relative flex justify-between w-full md:w-[80%] transition-all duration-300 z-30 
            }`}
          >
