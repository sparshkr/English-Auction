...
export default function Home() {
  ...
  return (
    <div className="grid justify-center grid-cols-1 sm:grid-cols-[1fr_512px_1fr] bg-gradient-to-b from-[#4A038B] to-[#0C0D29] overflow-hidden min-h-screen">
      <div className="relative col-start-2 col-span-1 mb-2 overflow-hidden px-4 sm:px-0 flex flex-col">
        ...
        <div className="relative z-50 my-0 mb-6 sm:mb-10">
          <Topbar />
        </div>

        <div className="relative z-90 text-white text-xl sm:text-2xl lg:px-8 mb-4 flex justify-between items-center px-2">
